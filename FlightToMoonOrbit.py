...
teta=(pi/2)-alphaM+w0*t_pr #угол поворота ,используемой системы координат, относительной системы с осью х направленной к начальному положению луны
print(teta)
print(t0)
YYY=[]
#РС
...
#Проверка совпадения систем координат
print(ms.acos(X_m/r0))
print(w0*t_spent)
