...
teta=w0*t0+(pi/2)-alphaM+w0*t_pr #угол поворота ,используемой системы координат, относительной системы с осью х направленной к нчальному положению луны
print(teta)
print(t0)
YYY=[]
#РС
